...
blue = Ghost("blue",UNIT_SQUARE*14.5,15.5*UNIT_SQUARE,2,0, "random")
red = Ghost("red",UNIT_SQUARE*27.5,2.5*UNIT_SQUARE,-2,0, "random")
orange = Ghost("orange", UNIT_SQUARE*15.5, 15.5*UNIT_SQUARE, 0, -2, "bfs")
...
while is_running:
    ...
    if moving:
        ...
        for i in range(len(ghosts)):
            ...
            if touched == True: 
                pinky = Ghost("pink",UNIT_SQUARE*14.5,15.5*UNIT_SQUARE,0,-2, "bfs")
                blue = Ghost("blue",UNIT_SQUARE*2.5,2.5*UNIT_SQUARE,2,0, "random")
                red = Ghost("red",UNIT_SQUARE*27.5,2.5*UNIT_SQUARE,-2,0, "random")
                orange = Ghost("orange", UNIT_SQUARE*15.5, 15.5*UNIT_SQUARE, 0, -2, "bfs")
                ghosts = [pinky, blue, red, orange]
